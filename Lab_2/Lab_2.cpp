    ...
    case WM_COMMAND:
        {
            ...
            case ID_OBJECTS_POINT:
                SOE.StartPointEditor(hWnd); //початок вводу точкових об’єктів
                break;
            case ID_OBJECTS_LINE:
                SOE.StartLineEditor(hWnd); //початок вводу об’єктів-ліній
                break;
            case ID_OBJECTS_RECTANGLE:
                SOE.StartRectangleEditor(hWnd); //початок вводу прямокутників
                break;
            case ID_OBJECTS_ELLIPSE:
                SOE.StartEllipseEditor(hWnd); //початок вводу еліпсів
                break;
            default:
