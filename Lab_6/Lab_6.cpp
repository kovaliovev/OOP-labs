// Lab_6.cpp : Defines the entry point for the application.
//
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      80, 280, 410, 320, nullptr, nullptr, hInstance, nullptr);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_ABOUT:
                ...
                break;
            case ID_ACTIONS_START:
                inputForm.OnStart(hWnd, hInst);
                break;
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
    ...
    case WM_DESTROY:
        ...
        if (hWndObject2) PostMessage(hWndObject2, WM_DESTROY, NULL, NULL);

        hWndObject3 = FindWindow(L"OBJECT3", NULL);
        if (hWndObject3) PostMessage(hWndObject3, WM_DESTROY, NULL, NULL);
